 ...
 * Description  A class representing the AddPlayer JDialog
 * Date         10/06/2023     
...
public class AddPlayer extends javax.swing.JDialog {
    ...
    private final int MAX_AGE = 150;            // Maximum age for player
    ...
    * Description  Creates an instance of AddPlayer JDialog form
    * Date         10/06/2023     
    * @author      <i>Kirill Grichanichenko</i>           
    *****************************************************************************/
    public AddPlayer()
    ...
    *****************************************************************************/
    ...
    /**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    * Method       AddPlayer()
    * Description  Adds a the new player.
    * Date         10/06/2023     
    * @author      <i>Kirill Grichanichenko</i>
    * @param       parent java.awt.Frame
    * @param       model Boolean
    *****************************************************************************/
    public AddPlayer(java.awt.Frame parent, boolean model) {
        super(parent, model);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        addEditJLabel.setText("Add New Player");
        ...
        titleJPanelLayout.setHorizontalGroup(
            ...
            .addGroup(titleJPanelLayout.createSequentialGroup()
                ...
                .addComponent(logoJLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(displayJPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    *****************************************************************************/
    private void saveJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveJButtonActionPerformed
        ...
        else if(Validation.isGreaterThan(correctString, totalString)) // Checks to see if correct questions is greater than total questions
        {
            errorMessage += "Invalid Number\n";
            correctJTextField.requestFocus();
            error = true;
        ...
        else if(Validation.isGreaterThan(totalString, maxQuestions)) // Checks to see if total questions is less than or equal to max questions.
        {
            errorMessage += "Invalid Total\n";
            totalJTextField.requestFocus();
            error = true;
        ...
        if (!error) // all fields are valid, create a newPlayer
        {
            ...
            {
                // Should never get here, throw runtime exception
